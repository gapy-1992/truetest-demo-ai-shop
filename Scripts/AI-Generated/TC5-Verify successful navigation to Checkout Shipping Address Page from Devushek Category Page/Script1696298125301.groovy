...
'step 35: Add visual checkpoint at Page checkout shipping-address'

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify successful navigation to Checkout Shipping Address Page from Devushek Category Page_visual_checkpoint')
